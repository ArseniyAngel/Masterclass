...
class StartWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Сохраняем оригинальный стиль элементов
        self.original_styles = {}
        self.save_original_styles()

        # Создаем и настраиваем фоновый label
    ...
    def setup_background(self):
        ...
        self.bg_label.lower()  # На задний план
    ...
    def make_elements_transparent(self):
        ...
        for widget in self.findChildren(QtWidgets.QWidget):
            if widget != self.bg_label:
                ...
                # Добавляем прозрачность, сохраняя остальные стили
    ...
    def on_slider_released(self):
        ...
        # Сбрасываем цвет всех labels
        self.reset_text_colors()
        value = self.vertical_slider.value()
        # Определяем какой label подсвечивать
        if value == 3:
